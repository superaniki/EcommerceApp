...
namespace EcommerceApp.Migrations
{
    ...
    [Migration("20240620143333_UpdateCustomerForIdentification")]
    partial class UpdateCustomerForIdentification
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceApp.Models.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommerceApp.Models.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommerceApp.Models.BasketItem", b =>
                {
                    b.HasOne("EcommerceApp.Models.Basket", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("EcommerceApp.Models.Customer", b =>
                {
                    b.HasOne("EcommerceApp.Models.ApplicationUser", "User")
                        .WithOne("Customer")
                        .HasForeignKey("EcommerceApp.Models.Customer", "UserId")
